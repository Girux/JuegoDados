...
public class FrmJuego extends JFrame {
    ...
    public FrmJuego() {
        ...
        lblLanzamientos.setForeground(new Color(51, 225, 0));
        ...
        lblCenas.setForeground(new Color(51, 225, 0));
        ...
        btnIniciar.setBounds(10, 135, 100, 25);
        getContentPane().add(btnIniciar);

        JButton btnLanzar = new JButton("Lanzar");
        btnLanzar.setBounds(10, 175, 100, 25);
